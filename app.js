(() => {
  ...
  function activeFilterText() {
    ...
    return parts.length ? parts.join(' · ') : 'Full Super Admin record';
  }
  ...
  function openFinding(id, updateHash = true) {
    ...
    elements.dialogContent.innerHTML = `
      ...
      <section class="detail-section">
        ...
        <p>${escapeHtml(finding.evidenceStatus)} · 12 September Super Admin Chrome priority campaign. Private <code>tests/e2e/admin/</code> run records are the source of this sanitized consolidation. <a href="#coverage" id="dialog-coverage">View scenario coverage and provenance</a>.</p>
      ...
      <section class="detail-section">
        <h3>Lifecycle</h3>
        <div class="timeline">
          <div class="timeline-item done"><strong>Finding recorded</strong><small>${finding.scenario} · Super Admin Chrome evidence run</small></div>
  ...
  function exportCsv() {
    ...
    link.download = 'super-admin-uat-20260912.csv';
    link.click();
